...
-- Customers who have placed orders with total amount between 500 and 1000
...
-- Total amount paid by customers from the UK who have ordered more than 3 items in a single order
...
--  Top 2 highest payments adjusted for VAT (12.2%) for customers from the UK and Australia
SELECT TOP 2 
...
-- Total quantity sold for each product, ordered by quantity in descending order 
...
-- Stored Procedure for Discount Application
...
-- Products that have been purchased by more than 3 customers
SELECT 
    p.product_id, 
    p.product_name
FROM Products p
...
-- Top 10 customer ranking by spending 
